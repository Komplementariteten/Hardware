...
#
# Generated by Vivado on Sun Mar 27 15:50:44 CEST 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../AXU2CGA_PLL.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../AXU2CGA_PLL.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/me/Workspace/Hardware/Verilog/AXU2CGA_PLL/AXU2CGA_PLL.cache/compile_simlib/vcs"
  fi
