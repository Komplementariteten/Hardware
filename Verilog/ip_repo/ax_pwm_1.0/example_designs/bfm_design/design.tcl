proc create_ipi_design { offsetfile design_name } {
	...
	set ax_pwm_0 [ create_bd_cell -type ip -vlnv user.org:user:ax_pwm:1.0 ax_pwm_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:ax_pwm:1.0]]]]
