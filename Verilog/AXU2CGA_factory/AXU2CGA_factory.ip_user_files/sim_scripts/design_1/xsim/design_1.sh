...
# Set xvlog options
xvlog_opts="--incr --relax -L uvm -L axi_vip_v1_1_11 -L zynq_ultra_ps_e_vip_v1_0_11 -L mipi_dphy_v4_3_3 -L xilinx_vip"
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d10d.protoinst" -protoinst "protoinst_files/bd_d92b.protoinst" -protoinst "protoinst_files/bd_19ea.protoinst" -protoinst "protoinst_files/bd_108c.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
