...
# Path of this script: /home/me/Workspace/Hardware/Vitis/DMA_Loop/xaxidma_example_simple_poll_1_system/_ide/scripts/systemdebugger_xaxidma_example_simple_poll_1_system_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source /home/me/Workspace/Hardware/Vitis/DMA_Loop/xaxidma_example_simple_poll_1_system/_ide/scripts/systemdebugger_xaxidma_example_simple_poll_1_system_standalone.tcl
# 
...
set bp_43_8_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_43_8_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
